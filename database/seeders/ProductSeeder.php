...
class ProductSeeder extends Seeder
{
    public function run(): void
    {
        $products = [
            ...
            ['name' => 'Classic Teak Dining Chair', 'price' => 1400000, 'category' => 'Kursi', 'color' => 'Brown', 'material' => 'Kayu Jati', 'stock' => 20, 'img' => '/assets/images/products/produk-26.jpg', 'description' => 'Kursi makan klasik yang terbuat dari kayu jati asli. Sangat kokoh, tahan lama, dan memiliki serat kayu yang indah.'],
            ...
            ['name' => 'Minimalist Sliding Wardrobe', 'price' => 7600000, 'category' => 'Lemari', 'color' => 'White & Wood', 'material' => 'Kayu', 'stock' => 6, 'img' => '/assets/images/products/produk-28.jpg', 'description' => 'Lemari pakaian dengan pintu geser (sliding) yang menghemat ruang. Desain minimalis perpaduan warna putih dan kayu natural.'],
            ...
            ['name' => 'Industrial Study Desk', 'price' => 3100000, 'category' => 'Meja', 'color' => 'Rustic Brown', 'material' => 'Kayu & Besi', 'stock' => 14, 'img' => '/assets/images/products/produk-30.jpg', 'description' => 'Meja belajar atau meja kerja bergaya industrial. Memiliki rangka besi hitam tebal dan permukaan kayu bernuansa *rustic*.'],
            ['name' => 'Aesthetic Rattan Chair', 'price' => 2100000, 'category' => 'Kursi', 'color' => 'Natural Rattan', 'material' => 'Rotan & Kayu', 'stock' => 12, 'img' => '/assets/images/products/produk-31.jpg', 'description' => 'Kursi teras atau kursi santai dengan anyaman rotan asli yang estetik. Memberikan kesan *tropical* dan santai pada hunian Anda.'],
            ...
            ['name' => 'Contemporary Accent Chair', 'price' => 3800000, 'category' => 'Kursi', 'color' => 'Mustard Yellow', 'material' => 'Velvet', 'stock' => 7, 'img' => '/assets/images/products/produk-34.jpg', 'description' => 'Kursi aksen bergaya kontemporer dengan warna kuning mustard yang berani. Menjadi *focal point* yang menarik di ruangan Anda.'],
        ];
